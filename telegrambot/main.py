...
bot = telebot.TeleBot('5033223130:AAHP6-LA5vFqRdhL9mJwwmZF69wfKwDOOnA')

conn = psycopg2.connect(database="pyatlab", user="postgres", password="1911", host="localhost", port="5432")
cursor = conn.cursor()
